...
public class ThreadExecutorsAlarm_7 {
    ...
    private static class MyThread implements Runnable {
        ...
        BulkRequestBuilder bulkRequest=client.prepareBulk();
            try {
                ...
                //这里只是处理简单的，
                    //logger.info("list[i-7]========"+list.get(i));
...
//                            .setSource(list.get(i)));
                    ...
                    bulkRequest.add(client.prepareIndex("report_alarm_7", "alarm", null).setTTL(TimeValue.timeValueHours(999999999))
                ...
                logger.error("thread_report_alarm_7====InterruptedException:"+e.toString());
            } finally {
