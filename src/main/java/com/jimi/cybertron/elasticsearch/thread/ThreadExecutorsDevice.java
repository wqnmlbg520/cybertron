...
public class ThreadExecutorsDevice {
...
//                            .setSource(list.get(i)));
                    bulkRequest.add(client.prepareIndex(index, "device", jsonObject.getString("imei")).setTTL(TimeValue.timeValueHours(999999999))
                            .setSource(list.get(i)).setRouting(jsonObject.getString("imei")).request());
